    ...
    <div class="panel-body collapse in">
        ...
        <input type="hidden" name="id" value="<?php echo $listing->id?>">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" value="<?php echo $listing->kd_barang;?>" readonly="readonly"  name="kd_barang">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                   <select class="form-control" id="source" name="jenis_barang">
                        <option value="">--Pilih--</option>
                        <option value="padat" <?php if($listing->jenis_barang == 'padat'){ echo "selected=selected"; } ?> >Padat </option>
                        <option value="cair" <?php if($listing->jenis_barang == 'cair'){ echo "selected=selected"; } ?> >Cair </option>
                        <option value="serbuk" <?php if($listing->jenis_barang == 'serbuk'){ echo "selected=selected"; } ?> >Serbuk</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
