...
<div class="panel panel-midnightblue">
    ...
    <div class="panel-body collapse in">
        <form action="<?php echo base_url('pelanggan/pro_edit'); ?>" class="form-horizontal row-border" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                <textarea class="form-control" name="alamat"> <?php echo $listing->alamat; ?> </textarea> 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="no_telp" value="<?php echo $listing->no_telp; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="email" value="<?php echo $listing->email; ?>">
                </div>
            </div>
