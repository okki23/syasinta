...
<div class="panel panel-midnightblue">
    <div class="panel-heading">
        <h4>Form Edit Transaksi Barang Keluar </h4>
        <div class="options">   
    ...
    <div class="panel-body collapse in">
        <form action="<?php echo base_url('trans_barang_keluar/pro_edit');?>" method="POST" enctype="multipart/form-data" class="form-horizontal row-border">
