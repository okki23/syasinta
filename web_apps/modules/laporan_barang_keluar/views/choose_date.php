...
<div class="panel panel-midnightblue">
    <div class="panel-heading">
        <h4>Pilih Periode Tanggal Cetak Laporan Barang Keluar</h4>
        <div class="options">   
    ...
    <div class="panel-body collapse in">
        <form action="<?php echo base_url('laporan_barang_keluar/cetak'); ?>" class="form-horizontal row-border" method="POST">
           
            <div class="form-group">
                 
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="cek1" required="required" name="start" placeholder="Dari Tanggal">  
                    
                </div>

                <div class="col-sm-6">
                  
                    <input type="text" class="form-control" id="cek2" required="required" name="end" placeholder="Sampai Tanggal">
                </div>
            </div>
