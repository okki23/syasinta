              ...
              <div class="col-md-12">
                    <div class="panel panel-sky">
                        ...
                        <div class="panel-body collapse in">
                         <a href ="<?php echo base_url('trans_barang_masuk/add'); ?>" class="btn btn-xs btn-primary">  + Add </a> 
                         <br>
                         &nbsp; 
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href ="<?php echo base_url('trans_barang_masuk/edit/'.$row->id); ?>" class="btn btn-xs btn-warning"> Edit </a> &nbsp; 
                                            <a href = "<?php echo base_url('trans_barang_masuk/delete/'.$row->id); ?>" class="btn btn-xs btn-danger"> Delete </a>
                                        </td>
                                    </tr>
                                <?php     
                                }
