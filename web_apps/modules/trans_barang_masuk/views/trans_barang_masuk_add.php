...
//alert(data);
                $.ajax({
                 url : "<?php echo base_url('trans_barang_masuk/cek_barang');?>",
                 type : "POST",
                 dataType : "json",
                 data : {id:id},
...
<div class="panel panel-midnightblue">
    <div class="panel-heading">
        <h4>Form Add Transaksi Barang Masuk </h4>
        <div class="options">   
    ...
    <div class="panel-body collapse in">
        <form action="<?php echo base_url('trans_barang_masuk/pro_add');?>" method="POST" enctype="multipart/form-data" class="form-horizontal row-border">
            <div class="form-group">
                <label class="col-sm-3 control-label">Nama Barang</label>
                <div class="col-sm-6">
                    <select class="form-control" id="source" name="id_barang" onchange="Klik();">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" readonly class="form-control" name="sisa" id="sisa">
                </div>
            </div>
