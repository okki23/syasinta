...
class Model_laporan_barang_masuk extends CI_Model {
	...
	public function get_all_laporan_barang_masuk($start,$end){
 
	$query = $this->db->query("select a.*,b.nama as namabarang,c.nama as namagudang from trans_barang_masuk a 
