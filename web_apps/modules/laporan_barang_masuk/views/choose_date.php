...
<div class="panel panel-midnightblue">
    <div class="panel-heading">
        <h4>Pilih Periode Tanggal Cetak Laporan Barang Masuk</h4>
        <div class="options">   
    ...
    <div class="panel-body collapse in">
        <form action="<?php echo base_url('laporan_barang_masuk/cetak'); ?>" class="form-horizontal row-border" method="POST">
